...
\entry{2018 -- 2020}{Research Assistant Mentorship at JHU}
{\jhusom}{Baltimore, Maryland}
{Supervised and mentored Bronte Wen, Deeya Bhattacharya, and Nikita Gupta on fMRI analysis projects.}
...
\skillentry{fMRI}
{Data colelction (3T, 7T), preprocessing (fMRIprep, SPM), analysis (SPM, python)}
